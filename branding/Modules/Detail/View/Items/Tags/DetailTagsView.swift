...
final class DetailTagsView: UIView, NamedViewProtocol {
    private lazy var tagsListView: TagListView = {
        ...
        view.textColor = ApplicationConfig.Appearance.firstTintColor
        view.textFont = .systemFont(ofSize: 12, weight: .semibold)
...
extension DetailTagsView {
    func setup(viewModel: DetailTagsViewModel) {
        ...
        tagsListView.addTags(viewModel.tags)
    }
}
