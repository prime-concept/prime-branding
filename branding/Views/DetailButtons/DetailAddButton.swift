...
final class DetailAddButton: UIView {
    ...
    private let textFont: UIFont = .systemFont(ofSize: 12, weight: .semibold)
    ...
    private func setupAppearance() {
        ...
        view.setTitle(LS.localize("AddToFavorites"), for: .normal)
        view.setTitle(LS.localize("AddedToFavorites"), for: .selected)
